...
from PyQt5.QtWidgets import QDialog, QTableWidget, QAbstractItemView, QTableWidgetItem, QTableView, QLabel, QLineEdit, QPushButton, QHBoxLayout, QVBoxLayout
...
class FindDlg(QDialog):
    ...
    def __init__(self, title, records, fields, sizes, parent=None):
        ...
        # TODO - might need to update SIGNAL - was a PyQt4 implementation
        ...
        self.tableWidget.itemClick(QTableWidgetItem).connect(self.on_tableWidget_itemClicked)
        
        # self.connect(self.tableWidget, SIGNAL("itemDoubleClicked(QTableWidgetItem *)"),
        #     self.on_tableWidget_itemDoubleClicked)
        self.tableWidget.itemDoubleClicked(QTableWidgetItem).connect(self.on_tableWidget_itemDoubleClicked)
